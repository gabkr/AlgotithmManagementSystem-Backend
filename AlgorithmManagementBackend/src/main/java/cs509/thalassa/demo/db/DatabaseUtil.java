...
public class DatabaseUtil {
	...
	public final static String dbName = "amsProd";           // Whatever Schema you created in tutorial.
	public final static String testingName = "amsProd";       // used for testing (also default created)
