 ...
 */
public class ListAllClassificationsHandler implements RequestHandler<ListClassificationRequest,AllClassificationsResponse> {
	 ...
	 * @throws Exception 
	 */
	List<Classification> getClassifications(String parentClassification) throws Exception {
		logger.log("in getClassifications");
		ClassificationsDAO dao = new ClassificationsDAO(logger);
		
		return dao.getRelatedClassifications(parentClassification);
	}
	...
	**/
	...
	public AllClassificationsResponse handleRequest(ListClassificationRequest req, Context context)  {
		...
		try {
			...
			List<Classification> list = getClassifications(req.parentClassification);
			/**
